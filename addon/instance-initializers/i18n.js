export function initialize(application) {
	...
	console.info('[i18n]', 'User Language:', userLanguage); // eslint-disable-line
	console.info('[i18n]', 'Previous Language:', previousLanguage); // eslint-disable-line
	console.info('[i18n]', 'Current Language:', i18n.get('locale')); // eslint-disable-line
	console.info('[i18n]', 'All Languages:', allLanguages.join(', ')); // eslint-disable-line
}
